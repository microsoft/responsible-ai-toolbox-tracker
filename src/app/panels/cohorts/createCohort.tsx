...
export const CreateCohort: React.FunctionComponent = () => {
    ...
    */
    ...
    const [selectedDatasetFilter, setSelectedDatasetFilter] = useState(defaultOption)
    ...
    const [selectedDatasetOption, SetSelectedDatasetOption] = useState(defaultGroupOption);
