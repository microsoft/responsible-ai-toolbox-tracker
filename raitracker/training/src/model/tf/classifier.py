...
class _TFClassifier(Model):
    ...
    def __init__(
        ...
        super(_TFClassifier, self).__init__()
        self.regul = None
        if lambda_regul > 0:
    ...
    def _build_network(self):
        self._build_layers()
        self.final_activation = ly.Activation('softmax', name='output')
