...
# ************************************************************
# ************************************************************
class _TorchClassifierMultOut(nn.Module):
    ...
    def __init__(
        ...
        super(_TorchClassifierMultOut, self).__init__()
...
# ************************************************************
# ************************************************************
class TorchClassifierMultOut(TorchModel):
    ...
    def _get_model_architecture(self):
        encoder = _TorchClassifierMultOut(input_dim=self.input_dim, out_dim=self.out_dim)
        return encoder
